...
public class PCA9685PwmControl {
    ...
    private final BigDecimal    FREQUENCY = new BigDecimal("200"); //Frequency for PWM. Limit is variable, based on the steps or whatever - no documentation available
    private final BigDecimal    FREQUENCY_CORRECTION_FACTOR = new BigDecimal("1"); //For whatever
    private final int           PWM_OFF_VALUE = 0;
    private final int           PWM_MAX_VALUE = 4096;
    ...
    public void setAllPinsPwm(int value){
        setPwm(PCA9685Pin.PWM_00, value);
        setPwm(PCA9685Pin.PWM_01, value);
        setPwm(PCA9685Pin.PWM_02, value);
        setPwm(PCA9685Pin.PWM_03, value);
        setPwm(PCA9685Pin.PWM_04, value);
        setPwm(PCA9685Pin.PWM_05, value);
        setPwm(PCA9685Pin.PWM_06, value);
        setPwm(PCA9685Pin.PWM_07, value);
        setPwm(PCA9685Pin.PWM_08, value);
        setPwm(PCA9685Pin.PWM_09, value);
        setPwm(PCA9685Pin.PWM_10, value);
        setPwm(PCA9685Pin.PWM_11, value);
        setPwm(PCA9685Pin.PWM_12, value);
        setPwm(PCA9685Pin.PWM_13, value);
        setPwm(PCA9685Pin.PWM_14, value);
        setPwm(PCA9685Pin.PWM_15, value);
    }
